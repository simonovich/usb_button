...
volatile boolean state = true; // состояние светодиода, false - ВЫКЛ, true - ВКЛ
...
void setup() {
  ...
  attachInterrupt (0, button_press, RISING); // установка прерывания №0 (цифровой вывод 2) по изменению сигнала с низкого уровня (0 В) на высокий уровень (5 В), т.е. по переднему фронту сигнала с кнопки.
